...
import { Star, ShieldAlert, BadgeCheck, CheckCircle2 } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {reviews.map((rev, idx) => (
            <div
              key={idx}
              className="bg-white rounded-custom-lg border border-border-subtle p-8 flex flex-col justify-between luxury-shadow hover:border-primary/20 transition-all duration-300"
            >
              <div>
                {/* Rating stars */}
              ...
              <div className="pt-6 border-t border-border-subtle flex items-center justify-between">
                ...
                <span className="inline-flex items-center px-2 py-0.5 rounded text-[8px] font-semibold bg-[#E6ECE8] text-primary border border-primary/5 tracking-wider uppercase">
