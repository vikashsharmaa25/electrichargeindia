      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center space-x-3 group">
          ...
          <div className="flex flex-col">
            <span className="font-heading font-semibold text-base sm:text-lg tracking-tight text-primary flex items-center">
              EV HINDUSTAN
            ...
            <span className="text-[9px] sm:text-[10px] tracking-wider text-text-muted uppercase font-medium">
        ...
        <div className="hidden lg:flex items-center space-x-8">
          {navLinks.map((link) => (
            ...
            >
              <button className="flex items-center text-sm font-medium text-text-main hover:text-primary transition-colors py-2">
                {link.title}
                <ChevronDown
          ...
          <Link href="#verification" className="text-sm font-medium text-text-main hover:text-primary transition-colors">
            Process
          </Link>
          <Link href="#faq" className="text-sm font-medium text-text-main hover:text-primary transition-colors">
            FAQs
          </Link>
        </div>
        ...
        <div className="lg:hidden flex items-center space-x-3">
          <button
            ...
            className="p-2 rounded-xl border border-border-subtle bg-white text-text-main hover:bg-bg-secondary transition-colors"
          >
